...
def test_normalize_text_only_response() -> None:
    ...
    assert normalize(response) == {"text": "hello", "tool_name": None, "tool_args": None}
...
def test_normalize_missing_choices_returns_null_fields() -> None:
    assert normalize({}) == {"text": None, "tool_name": None, "tool_args": None}


def test_normalize_missing_message_content_and_tools_returns_nulls() -> None:
    response = {"choices": [{"message": {}}]}
    assert normalize(response) == {"text": None, "tool_name": None, "tool_args": None}
